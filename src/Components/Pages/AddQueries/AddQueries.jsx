...
const AddQueries = () => {
  ...
  const handelQueryAddBtn = (e) => {
    ...
    axios
      .post(
        "https://assignment-11-server-liard-five.vercel.app/add-queries",
        addQueries
      )
      .then((res) => {
  ...
  return (
    <section className="max-w-[1170px] lg:mx-auto  my-8 max-sm:mx-3 md:mx-5 mt-28">
      ...
      <div className="p-6 bg-green-100 mt-5 rounded-xl">
        <form
          onSubmit={handelQueryAddBtn}
          noValidate=""
          action=""
          className="container font-poppins flex flex-col mx-auto space-y-12"
        >
          <fieldset className="py-5 px-10">
            <div className="text-center">
              <p className="font-palyfair text-3xl md:text-5xl text-[#374151] font-bold">
                Add New Queries
              </p>
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3 mt-10 font-raleway">
              <div className="col-span-full sm:col-span-3">
                <label htmlFor="firstname" className="md:text-xl font-semibold">
                  Product Name
                </label>
                <input
                  required
              ...
              <div className="col-span-full sm:col-span-3">
                <label htmlFor="lastname" className="md:text-xl font-semibold">
                  Product Brand
                </label>
                <input
                  required
              ...
              <div className="col-span-full">
                <label htmlFor="address" className="md:text-xl font-semibold">
                ...
                <textarea
                  ...
                  rows="4"
                  cols="50"
                  className="w-full mt-2 pt-1   pl-3 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300"
                ></textarea>
              </div>
              <div className="col-span-full mt-3">
                <input
                  ...
                  type="submit"
                  value="Add Query"
                  className="w-full text-lg md:text-2xl hover:bg-green-600 font-rachno h-12 btn text-yellow-950 bg-green-500"
                />
              </div>
            </div>
          </fieldset>
